//
//  InformationEngineeringEngBuildingViewModel.swift
//  ARCL_Test
//
...
final class InformationEngineeringEngBuildingViewModel {
    
    
    static func build() -> [OfficeObject]
    {
        guard let path = Bundle.main.path(forResource: "InformationEngineeringEngBuilding", ofType: "json") else {
