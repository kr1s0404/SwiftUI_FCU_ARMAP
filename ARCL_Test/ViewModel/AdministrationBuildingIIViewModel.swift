//
//  AdministrationBuildingIIViewModel.swift
//  ARCL_Test
//
...
final class AdministrationBuildingIIViewModel {
    
    
    static func build() -> [OfficeObject]
    {
        guard let path = Bundle.main.path(forResource: "AdministrationBuildingII", ofType: "json") else {
